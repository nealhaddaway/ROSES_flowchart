    ...
    tabPanel("Home",
         fluidRow(
            column(10, offset = 1,
                   ...
                   br(),
                   br(),
                   'Please let us know if you have any feedback or if you encounter an error by sending an email to ', tags$a(href="mailto:nealhaddaway@gmail.com", "nealhaddaway@gmail.com"),
                   br(),
                   br(),
                   '***TO BEGIN***',
                   br(),
